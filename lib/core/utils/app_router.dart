...
import 'package:online_shop/features/account/views/edit_profile_view.dart';
import 'package:online_shop/features/account/views/google_maps_view.dart';
import 'package:online_shop/features/account/views/language_view.dart';
import 'package:online_shop/features/account/views/new_address_view.dart';
import 'package:online_shop/features/account/views/notifications_view.dart';
import 'package:online_shop/features/account/views/order_history_view.dart';
import 'package:online_shop/features/account/views/shipping_address_view.dart';
import 'package:online_shop/features/account/views/theme_view.dart';
import 'package:online_shop/features/account/views/track_order_view.dart';
import 'package:online_shop/features/account/views/view_order_view.dart';
import 'package:online_shop/features/account/views/wishlist_view.dart';
import 'package:online_shop/features/authentication/views/phone_number_verification_view.dart';
import 'package:online_shop/features/authentication/views/login_view.dart';
import 'package:online_shop/features/authentication/views/signup_view.dart';
...
import 'package:online_shop/features/checkout/views/checkout_view.dart';
import 'package:online_shop/features/checkout/views/order_summary_view.dart';
import 'package:online_shop/features/checkout/views/pay_with_credit_card_view.dart';
import 'package:online_shop/features/explore/models/product_model.dart';
import 'package:online_shop/features/explore/views/best_selling_view.dart';
import 'package:online_shop/features/explore/views/category_view.dart';
import 'package:online_shop/features/explore/views/item_details_view.dart';
import 'package:online_shop/features/explore/views/recommended_view.dart';
import 'package:online_shop/features/explore/views/search_view.dart';
import 'package:online_shop/features/explore/views/write_review_view.dart';
import 'package:online_shop/features/root/views/root_view.dart';
import 'package:online_shop/features/splash/splash_view.dart';
